...
const Footer = () => {
  return (
    <>
      <footer
        style={{ backgroundColor: "#113381" }}
        className="wow fadeInUp relative z-10 bg-opacity-5 pt-16 md:pt-20 lg:pt-24"
        data-wow-delay=".1s"
      >
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full pl-4 px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className=" px-12  mb-12 max-w-[360px] lg:mb-16">
                <Link href="/" className="mb-8 inline-block"></Link>
                <p className="mb-9 text-base font-medium leading-relaxed text-body-color">
                  Smoothening the real estate bussiness accross the world
                </p>
              ...
              <div className="mb-12 lg:mb-16">
                ...
                <ul>
                  <li>
                    ...
                    >
                      Spotting the best places to rent
                    </Link>
                  </li>
                  <li>
                    <Link
